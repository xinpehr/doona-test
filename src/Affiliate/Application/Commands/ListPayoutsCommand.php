...
use Affiliate\Application\CommandHandlers\ListPayoutsCommandHandler;
...
#[Handler(ListPayoutsCommandHandler::class)]
class ListPayoutsCommand extends CountPayoutsCommand
{
