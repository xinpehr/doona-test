...
use Ai\Application\CommandHandlers\GenerateTranscriptionCommandHandler;
...
#[Handler(GenerateTranscriptionCommandHandler::class)]
class GenerateTranscriptionCommand
{
