...
use Ai\Application\CommandHandlers\ListLibraryItemsCommandHandler;
...
#[Handler(ListLibraryItemsCommandHandler::class)]
class ListLibraryItemsCommand extends CountLibraryItemsCommand
{
