...
class __TwigTemplate_5a92b4cf239bd5edd803aeffea06fb94 extends Template
{
    ...
    {
        $macros = $this->macros;
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::titleCase($this->env->getCharset(), p__("title", "Settings")), "html", null, true);
        yield from [];
    }
    ...
    public function block_template(array $context, array $blocks = []): iterable
    {
        ...
        // line 8
        yield "\t<h1>";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Settings"), "html", null, true);
        yield "</h1>

\t<div>
\t\t<h2>";
        // line 11
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Common"), "html", null, true);
        yield "</h2>
...
\t\t\t\t\t\t";
        // line 20
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Website and SEO"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 29
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Public details"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 31
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Address, contacts etc."), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 40
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Policies"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 42
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Legal terms"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 51
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "PWA"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 53
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Progressive Web App settings"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 62
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Features"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 64
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Configure features"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t\t";
        // line 75
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Configure AI models"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t<h2>";
        // line 83
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Branding"), "html", null, true);
        yield "</h2>
...
\t\t\t\t\t<h3>";
        // line 90
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Logo"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 92
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Logo and favicon"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 101
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Appearance"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 103
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Color schemes etc."), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t<h2>";
        // line 111
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Finance"), "html", null, true);
        yield "</h2>
...
\t\t\t\t\t<h3>";
        // line 118
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Billing"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 120
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Currency and subscriptions"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 129
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Payments"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 131
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Payment gateway integrations"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 140
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Credit ratios"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 142
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Credit usage rates"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 151
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Exchange"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 153
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Currency exchange rate providers"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 164
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Affiliates"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 166
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Affiliate program settings"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t<h2>";
        // line 174
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Email"), "html", null, true);
        yield "</h2>
...
\t\t\t\t\t<h3>";
        // line 181
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Mail"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 183
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Transport and sender details"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 192
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "SMTP"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 194
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("SMTP transport details"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t<h2>";
        // line 202
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "User accounts"), "html", null, true);
        yield "</h2>
...
\t\t\t\t\t<h3>";
        // line 209
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Account settings"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 211
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Accounts and sign up form"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 220
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Identity providers"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 222
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("3rd party identiy providers"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 231
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "CAPTCHA"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 233
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Google reCAPTCHA"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t<h2>";
        // line 241
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "File storage"), "html", null, true);
        yield "</h2>
...
\t\t\t\t\t<h3>";
        // line 248
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Storage settings"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 250
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("File storage settings"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 259
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Cloud storage"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 261
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Integrated cloud storage options"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t<h2>";
        // line 269
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Integrations"), "html", null, true);
        yield "</h2>
...
\t\t\t\t\t\t";
        // line 278
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("API keys and service config"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 365
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Google Cloud Platform"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 367
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Google credentials for TTS etc."), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 376
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Azure"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 378
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Credentials for Azure TTS etc."), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t<a href=\"admin/settings/aimlapi\" class=\"flex gap-4 items-center box hover:border-line\">
\t\t\t\t<span class=\"avatar\">
\t\t\t\t\t<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"23\" height=\"21\" viewbox=\"0 0 23 21\" fill=\"none\">
\t\t\t\t\t\t<mask id=\"mask1_1_36\" style=\"mask-type:alpha\" maskunits=\"userSpaceOnUse\" x=\"0\" y=\"0\" width=\"23\" height=\"21\">
\t\t\t\t\t\t\t<path d=\"M22.6669 9.06242C23.1034 9.81847 23.1034 10.75 22.6669 11.506L18.1401 19.3467C17.7036 20.1027 16.8969 20.5685 16.0239 20.5685H6.97038C6.09737 20.5685 5.29068 20.1027 4.85417 19.3467L0.327377 11.506C-0.109127 10.75 -0.109125 9.81847 0.327379 9.06242L4.85417 1.22179C5.29068 0.465744 6.09737 0 6.97038 0H16.0239C16.8969 0 17.7036 0.465745 18.1401 1.22179L22.6669 9.06242Z\" fill=\"currentColor\"/>
\t\t\t\t\t\t</mask>
\t\t\t\t\t\t<g mask=\"url(#mask1_1_36)\">
\t\t\t\t\t\t\t<g>
\t\t\t\t\t\t\t\t<path d=\"M16.9508 12.5632C26.2299 8.12153 9.56998 -24.081 12.268 -13.5355C14.0198 -6.68875 7.90618 -7.71248 8.52593 -3.93352C9.40423 1.42189 8.90688 4.18523 6.3567 5.74115C10.5063 7.89075 9.5275 16.1164 16.9508 12.5632Z\" fill=\"currentColor\"/>
\t\t\t\t\t\t\t</g>
\t\t\t\t\t\t\t<g>
\t\t\t\t\t\t\t\t<path d=\"M-13.1094 -2.29349C-7.82128 -1.60151 -9.64942 -7.49638 2.88647 -2.0493C10.8705 1.41992 11.7366 15.2689 6.88381 19.5307C2.21229 23.6333 -29.7826 16.8042 -25.7092 16.4775C-1.39544 14.5274 2.71477 9.89756 -13.1094 -2.29349Z\" fill=\"currentColor\"/>
\t\t\t\t\t\t\t</g>
\t\t\t\t\t\t\t<g>
\t\t\t\t\t\t\t\t<path d=\"M21.6704 31.5945C30.1671 27.5275 14.912 -1.9594 17.3826 7.69679C18.9866 13.9662 13.3885 13.0288 13.956 16.4891C14.7602 21.3929 14.3048 23.9232 11.9697 25.3479C15.7694 27.3162 14.8731 34.8482 21.6704 31.5945Z\" fill=\"currentColor\"/>
\t\t\t\t\t\t\t</g>
\t\t\t\t\t\t\t<g>
\t\t\t\t\t\t\t\t<path d=\"M24.1729 2.77419C20.4892 -2.17345 5.24743 10.3844 10.6154 7.86309C14.1006 6.22614 14.3789 9.84723 16.3499 9.14401C19.1432 8.14743 20.7144 8.18165 21.9091 9.51074C22.5116 6.91988 27.1199 6.73231 24.1729 2.77419Z\" fill=\"currentColor\"/>
\t\t\t\t\t\t\t</g>
\t\t\t\t\t\t\t<g>
\t\t\t\t\t\t\t\t<path d=\"M20.7044 15.0888C17.2431 9.22062 -11.7401 25.2217 -2.37651 21.9052C3.70283 19.752 2.52284 24.1556 5.86216 23.2093C10.5945 21.8681 12.9923 21.8391 14.2373 23.4063C16.3127 20.2194 23.4736 19.7833 20.7044 15.0888Z\" fill=\"currentColor\"/>
\t\t\t\t\t\t\t</g>
\t\t\t\t\t\t\t<path d=\"M23.4894 -6.8722H-7.56133V24.8778H23.4894V-6.8722Z\" fill=\"currentColor\"/>
\t\t\t\t\t\t</g>
\t\t\t\t\t\t<path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M6.52895 13.737C6.35869 13.737 6.18737 13.6827 6.04266 13.572C5.69363 13.3028 5.62766 12.8016 5.89687 12.4526L9.08172 8.31323C9.21154 8.14404 9.40414 8.03444 9.61483 8.00784C9.82978 7.98017 10.0404 8.03976 10.2075 8.17277L13.2082 10.5298L15.8334 7.14272C16.1037 6.79264 16.6038 6.72773 16.9528 7.00014C17.3018 7.27042 17.3657 7.77161 17.0954 8.11957L13.9776 12.1419C13.8478 12.31 13.6562 12.4196 13.4455 12.4452C13.2327 12.4739 13.022 12.4122 12.8539 12.2813L9.85532 9.92536L7.16209 13.4252C7.0046 13.6295 6.76837 13.737 6.52895 13.737Z\" fill=\"rgba(var(--color-main))\"/>
\t\t\t\t\t</svg>
\t\t\t\t</span>
...
\t\t\t\t\t\t";
        // line 499
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("API for Suno AI etc."), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t\t";
        // line 514
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Push notifications"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t\t";
        // line 530
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Google search API"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t\t";
        // line 546
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Google search & YouTube API"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t\t\t<h3>";
        // line 555
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Script Tags"), "html", null, true);
        yield "</h3>
\t\t\t\t\t<p class=\"mt-1 text-sm text-content-dimmed\">
\t\t\t\t\t\t";
        // line 557
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Custom tags, Google Analytics etc."), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t<h2>";
        // line 565
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(p__("heading", "Custom LLM Servers"), "html", null, true);
        yield "</h2>
...
\t\t\t\t\t\t<h3>Ollama</h3>
\t\t\t\t\t\t<i class=\"text-base cursor-auto ti ti-test-pipe text-content-dimmed hover:text-content\" x-tooltip.raw=\"";
        // line 582
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Experimental"), "html", null, true);
        yield "\"></i>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t";
        // line 586
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Local LLM server for various models"), "html", null, true);
        yield "
\t\t\t\t\t</p>
\t\t\t\t</div>
\t\t\t</a>
...
\t\t\t";
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::filter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["config"] ?? null), "model", [], "any", false, false, false, 591), "registry", [], "any", false, false, false, 591), "directory", [], "any", false, false, false, 591), function ($__llm__) use ($context, $macros) { $context["llm"] = $__llm__; return (((CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "custom", [], "any", true, true, false, 591) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "custom", [], "any", false, false, false, 591)))) ? (CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "custom", [], "any", false, false, false, 591)) : (false)); }));
        foreach ($context['_seq'] as $context["_key"] => $context["llm"]) {
            // line 592
            yield "\t\t\t\t<div class=\"flex gap-4 items-center box hover:border-line group\" x-ref=\"llm-";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "key", [], "any", false, false, false, 592), "html", null, true);
            yield "\">
\t\t\t\t\t<a href=\"admin/settings/llms/";
            // line 593
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "key", [], "any", false, false, false, 593), "html", null, true);
            yield "\" class=\"flex gap-4 items-center grow\">
\t\t\t\t\t\t<x-avatar title=\"";
            // line 594
            yield (((CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "name", [], "any", true, true, false, 594) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "name", [], "any", false, false, false, 594)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "name", [], "any", false, false, false, 594), "html", null, true)) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Untitled"), "html", null, true)));
            yield "\"></x-avatar>
...
\t\t\t\t\t\t\t\t<h3 class=\"";
            // line 598
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "name", [], "any", false, false, false, 598)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("") : ("text-content-dimmed"));
            yield "\">";
            yield (((CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "name", [], "any", true, true, false, 598) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "name", [], "any", false, false, false, 598)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "name", [], "any", false, false, false, 598), "html", null, true)) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Untitled"), "html", null, true)));
            yield "</h3>
\t\t\t\t\t\t\t\t<i class=\"text-base cursor-auto ti ti-info-square-rounded-filled text-content-dimmed hover:text-content\" x-tooltip.raw=\"";
            // line 599
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Custom LLM server"), "html", null, true);
            yield "\"></i>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t";
            // line 603
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Custom OpenAI compatible LLM server"), "html", null, true);
            yield "
\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</a>

\t\t\t\t\t<button type=\"button\" class=\"text-2xl ms-auto opacity-0 transition-all group-hover:opacity-100 ti ti-trash text-content-dimmed hover:text-content\" x-tooltip.raw=\"";
            // line 608
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Delete"), "html", null, true);
            yield "\" @click.prevent=\"currentResource = `";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["llm"], "key", [], "any", false, false, false, 608), "html", null, true);
            yield "`; modal.open('llm-delete-modal')\"></button>
\t\t\t\t</div>
\t\t\t";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_key'], $context['llm'], $context['_parent']);
...
\t\t\t\t\t\t";
        // line 649
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Are you sure you want to delete the LLM server?"), "html", null, true);
        yield "
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t";
        // line 658
        yield from $this->load("/snippets/spinner.twig", 658)->unwrap()->yield($context);
        // line 659
        yield "
\t\t\t\t\t\t\t";
        // line 660
...
";
    ...
    {
        return "/templates/admin/settings/index.twig";
    }
    ...
    {
        return array (  988 => 660,  985 => 659,  983 => 658,  976 => 654,  968 => 649,  944 => 628,  937 => 624,  922 => 611,  911 => 608,  903 => 603,  896 => 599,  890 => 598,  883 => 594,  879 => 593,  874 => 592,  870 => 591,  862 => 586,  855 => 582,  835 => 565,  824 => 557,  819 => 555,  807 => 546,  788 => 530,  769 => 514,  751 => 499,  712 => 463,  696 => 450,  680 => 437,  656 => 416,  615 => 378,  610 => 376,  598 => 367,  593 => 365,  581 => 356,  563 => 341,  547 => 328,  529 => 313,  508 => 295,  488 => 278,  476 => 269,  465 => 261,  460 => 259,  448 => 250,  443 => 248,  433 => 241,  422 => 233,  417 => 231,  405 => 222,  400 => 220,  388 => 211,  383 => 209,  373 => 202,  362 => 194,  357 => 192,  345 => 183,  340 => 181,  330 => 174,  319 => 166,  314 => 164,  300 => 153,  295 => 151,  283 => 142,  278 => 140,  266 => 131,  261 => 129,  249 => 120,  244 => 118,  234 => 111,  223 => 103,  218 => 101,  206 => 92,  201 => 90,  191 => 83,  180 => 75,  175 => 73,  163 => 64,  158 => 62,  146 => 53,  141 => 51,  129 => 42,  124 => 40,  112 => 31,  107 => 29,  95 => 20,  90 => 18,  80 => 11,  73 => 8,  66 => 7,  55 => 5,  50 => 1,  48 => 3,  41 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "/templates/admin/settings/index.twig", "/home/appcloud/resources/views/templates/admin/settings/index.twig");
    }
}
